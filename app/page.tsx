    ...
    <div className="flex justify-center items-center h-screen">
      <div className="w-xl bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-200">
        ...
        <div className=" flex flex-col w-sm mx-auto space-y-2">
          ...
          <button
            disabled={loading}
            className="w-full md:w-auto bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold py-3 px-8 rounded-lg flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg hover:cursor-pointer mt-2"
            onClick={handleClick}
          >
